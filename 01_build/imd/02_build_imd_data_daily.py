...
def build_imd_data(ds_rain, ds_tmin, ds_tmax):
    ...
    ds_combined = ds_combined.assign_coords(
        ...
        day=('time', ds_combined['time'].dt.day.data)
    )
    ...
    # Rearrange columns
    df_summary = df_cleaned[['year', 'month', 'day', 'lat', 'lon', 'rain', 'tbar', 'tmin', 'tmax']]
...
export_dir = '/home/ved/dropbox/climate-lives/data/build/input/imd/daily'
...
# combined_data.to_csv(os.path.join(export_dir, 'imd_1951_2023_daily.csv'), index=False)
