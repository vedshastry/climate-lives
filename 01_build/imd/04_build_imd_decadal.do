...
*--------------------------------
    ...
    * Aggregate to decade level
    ...
    isid    id_xy census_dec
        ...
        * Count number of decades of climate data per grid point
        bys     id_xy (census_dec) : egen n_years = count(census_dec)
    ...
    * Save
    compress
    save "$b_input/imd/04_build_imd_decadal.dta" , replace
